...
namespace The_Look_Lab.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        public ProductsController(IWebHostEnvironment env, IRepository<Product> genericProductRepository)
        {
            _env = env;
        ...
        {
            List<Product> products = _genericProductRepository.GetAll().ToList();
        ...
        public IActionResult AddProduct(string name, string description, int price, string brand, string category, IFormFile image)
        {
            ...
            _genericProductRepository.Add(p);
        ...
        public IActionResult EditProduct(string name, string description, int price, string brand, string category, IFormFile image, string productString) 
        {
            ...
            _genericProductRepository.Update(newProduct);
            return RedirectToAction("ManageProducts", "Products");
        ...
        {
            Product productToDelete = _genericProductRepository.GetById(productId);
            if (productToDelete != null)
            {
                string imagePath = productToDelete.Image;
                _genericProductRepository.DeleteById(productId);
        ...
        {
            Product product = _genericProductRepository.GetById(productId);
            return View(product);
        }
